...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.statusbar.setStyleSheet("background:rgb(211, 222, 216);")
        ...
        self.toolBar.setStyleSheet("background:rgb(96, 140, 117);border-color:#373737;color:#F7F7F7")
        self.SelModel = QtWidgets.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("icon/data.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icon/open.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icon/stop.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon3.addPixmap(QtGui.QPixmap("icon/pause.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap("icon/stop.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        self.listWidget.setStyleSheet("background:rgb(211, 222, 216);  border-image:none; border: 1px solid #3D3D3D; border-radius: 2px;")
        self.centralwidget.setStyleSheet("background:rgb(211, 222, 216)")
        self.groupBox.setStyleSheet("background:rgb(211, 222, 216)")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "KWF YOLOv5 Detection"))
